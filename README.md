...
If an exercise directory contains files outside the test-derived whitelist for that exercise, the runner reports them as a non-fatal warning in the summary.
